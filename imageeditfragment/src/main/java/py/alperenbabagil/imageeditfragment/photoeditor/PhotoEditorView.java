...
public class PhotoEditorView extends RelativeLayout{
    ...
    private void init(@Nullable AttributeSet attrs){
        ...
        if(attrs != null){
            TypedArray a = getContext().obtainStyledAttributes(attrs,py.alperenbabagil.imageeditfragment.R.styleable.PhotoEditorView);
            Drawable imgSrcDrawable = a.getDrawable(py.alperenbabagil.imageeditfragment.R.styleable.PhotoEditorView_photo_src);
